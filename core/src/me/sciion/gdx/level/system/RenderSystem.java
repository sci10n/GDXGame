...
public class RenderSystem extends EntitySystem {
	...
	dummyModel = ModelConstructer.create(0.1f, 0.1f, 0.1f, Color.CYAN,t);
	dummyModel2 = ModelConstructer.create(0.1f, 0.1f, 0.1f, Color.RED,t);
	...
	lightOverlay = ModelConstructer.createMesh(11,1,11,22,22);
	...
	shaderProgram.setUniformf("screenWidth", Gdx.graphics.getWidth());
