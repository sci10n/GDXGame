...
public class ModelConstructer {
    ...
    public static ModelInstance create(float w, float h, float d, Texture texture){
 	   ...
 	   float x = w/2.0f;
 	       ...
 	       Material m = material;
 	       meshBuilder = build.part("pz", GL20.GL_TRIANGLES,Usage.Position | Usage.Normal | Usage.TextureCoordinates,m);
 	       ...
 	       meshBuilder.rect(-x,0,-z,
 		       		...
 		       		-x,y,-z,
 		       		-1.0f,0.0f, 0.0f);
 	       meshBuilder = build.part("py", GL20.GL_TRIANGLES,Usage.Position | Usage.Normal| Usage.TextureCoordinates,m);
